...
import { useTelemetry, useHistoricalTelemetry } from '../hooks/useTelemetry';
...
export default function ExecutiveDashboard() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      // Temporarily hide scrollbars for the export
      ...
      const pdf = new jsPDF({ unit: 'in', format: 'legal', orientation: 'portrait' });
      ...
      const margin = 0.5;
      const headerSpace = 0.8;
      const footerSpace = 0.5;
      
      const availableWidth = pageWidth - margin * 2;
      const availableHeight = pageHeight - margin * 2 - headerSpace - footerSpace;
      ...
      const yOffset = margin + headerSpace;
      
      // Draw Header
      pdf.setFont("helvetica", "bold");
      pdf.setFontSize(18);
      pdf.setTextColor(40, 40, 40);
      pdf.text("Executive Overview", margin, margin + 0.2);
      
      pdf.setFont("helvetica", "normal");
      pdf.setFontSize(11);
      pdf.setTextColor(100, 100, 100);
      pdf.text("Portfolio Health Summary V2.0", margin, margin + 0.45);
      ...
      pdf.text(`Generated by Observability.OS on ${timestamp}  |  Confidential`, pageWidth / 2, pageHeight - margin / 2, { align: "center" });
